...
namespace AboutTab {
    ...
    void Render() {
        ...
        if (openWelcome) {
            ...
            ImGui::Text("BombHacker is a highly sophisticated cheat menu for Among Us based on SickoMenu.");
            ...
            if (ImGui::Button("GitHub")) {
                OpenLink("https://github.com/Reborn5537/AUBombHacker");
            }
            ImGui::SameLine();
            if (ImGui::Button("Check for Updates")) {
                OpenLink("https://github.com/Reborn5537/AUBombHacker/releases/latest");
            }
            ...
            ImGui::TextColored(ImVec4(0.f, 1.f, 0.f, 1.f), "Make sure you have downloaded the latest version of BombHacker from GitHub or our");
        ...
        if (openCredits) {
            ...
            ImGui::Text("Thank you for making BombHacker possible!");
        }
        ImGui::EndChild();
    }
}